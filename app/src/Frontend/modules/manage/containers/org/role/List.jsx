...
export default React.createClass({
    ...
    action_show_permission_pannel(row){
        this.context.dataStore.actionPost(config.controller_permission,"get",{role_id:row.key},(result,error)=>{
            if(error){
    ...
    action_save_permission(){
        ...
        this.context.dataStore.actionPost(config.controller_permission,"save",data,(result,error)=>{
            if(error){
                this.setState({
                    loading_action_save:false
                });
