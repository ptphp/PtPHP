            ...
            <span>
                {
                    this.props.row.pid == 0 ?
                        <span className="department-row-item">
                            {this.props.row.cat_name}
                            <Button className="add_btn" style={{marginRight:10}}
                                    onClick={this.onShowAddModeal.bind(this,this.props.row)}
                                    size="small"
                                    type="primary">新加分类</Button>
                        </span>:
                        <Dropdown overlay={menu}>
                            <a className="department-row-item ant-dropdown-link" href="javascript:void(0)">
                                {this.props.row.cat_name} <Icon type="down" />
                            </a>
                        </Dropdown>
                }
            </span>
