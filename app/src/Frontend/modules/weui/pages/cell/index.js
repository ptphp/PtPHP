...
export default class CellDemo extends React.Component {
    state = {
        demoFiles : [
            ...
            },
            {
                url: avatarSrc,
                onRemove:(idx)=>{
                    let {demoFiles} = this.state
                    demoFiles = demoFiles.filter((file,key)=>{
                        return idx !== key;
                    });
                    this.setState({demoFiles});
                }
            },
            {
                url: avatarSrc
    ...
    render() {
        return (
            <Page className="cell" title="Cell" goBack={true}>
                    ...
                    <FormCell>
                        <CellBody>
                            <Uploader
                                ...
                                onChange={(file,e) => {
                                    let newFiles = this.state.demoFiles;
                                    newFiles.push({url:file.data});
                                    this.setState({
                                        demoFiles: newFiles
                                    });
                                }}
