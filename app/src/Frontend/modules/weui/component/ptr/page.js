...
class Page extends React.Component {
    ...
    render(){
        ...
        return (
            <div className={`page ${className}`} ref="container" style={ this.props.ptr ? {}: styles}>
                {this.renderptr()}
                <div className="hd">
                    <h1 className="title">{this.props.title}</h1>
                    <p className="sub_title">{this.props.subTitle}</p>
                </div>
                <div className={`bd ${this.props.spacing ? 'spacing' : ''}`}>
                    {this.props.children}
                </div>
            </div>
        );
