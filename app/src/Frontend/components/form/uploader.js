...
export default class Uploader extends React.Component {
    ...
    renderFiles(){
        return this.props.files.map((file, idx)=>{
            let {onRemove,url, error, status, ...others} = file;
            ...
            return (
                <li className={cls} key={idx} style={fileStyle} {...others}>
                    <div className="weui_uploader_del_btn" onClick={onRemove.bind(this,idx)}>
        ...
        return (
            <div className={cls}>
                ...
                <div className="weui_uploader_bd">
                    ...
                    <div className="weui_uploader_input_wrp" style={{display:this.props.files.length >= this.props.maxCount ? "none":""}}>
                        <input
